          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            ...
            >
              ...
              <form onSubmit={handleAddReforme} className="p-4 space-y-4 overflow-y-auto">
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">Image (Optionnelle)</label>
                    <div className="space-y-3">
                      <input
                        type="url"
                        value={reformeImageUrl}
                        onChange={(e) => setReformeImageUrl(e.target.value)}
                        className="w-full border border-slate-300 rounded-xl px-3 py-2 focus:ring-teal-500 focus:border-teal-500"
                            ...
                            <input 
                              ...
                              onChange={(e) => {
                                ...
                                if (file) {
                                  ...
                                  reader.onloadend = () => {
                                    setReformeImageUrl(reader.result as string);
                                  };
